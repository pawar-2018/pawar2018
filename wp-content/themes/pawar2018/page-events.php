			...
			<div class="small-12 medium-5 large-6 small-order-1 medium-order-2 columns">
				...
				<div class="event row align-center">
					...
					<div class="small-11 large-7  large-offset-1 columns event-copy">
						...
						<h5 class="event-header">
							<a href="https://www.facebook.com/events/378116495903323" target="_blank">
								First Mondays: What's Next for Illinois? w/ Ald. Ameya Pawar
							</a>
						</h5>
				...
				<div class="event row align-center">
					...
					<div class="small-11 large-7  large-offset-1 columns event-copy">
						<p class="event-date">Sunday, March 12th at 4PM</p>
						<h5 class="event-header">
							Meet & Greet with Ameya, Lakeview
						</h5>
						<p class="event-locale">The Crowd Theater</p>
						<p class="event-address">
							3935 N. Broadway
							<br />
							Chicago, IL
				...
				<div class="event row align-center">
					...
					<div class="small-11 large-7  large-offset-1 columns event-copy">
						<p class="event-date">Sunday, March 21st at 7PM</p>
						<h5 class="event-header">
							Meet & Greet with Action for a Better Tomorrow - Fox Valley
						</h5>
						<p class="event-locale">First Congregational Church</p>
						<p class="event-address">
							321 Hamilton Street
							<br />
							Geneva, IL
				...
				<div class="event row align-center">
					...
					<div class="small-11 large-7  large-offset-1 columns event-copy">
						<p class="event-date">Saturday, March 25th at 6:30PM</p>
						<h5 class="event-header">
								Meet & Greet with Ameya, Beverly
						</h5>
						<p class="event-locale">Beverly Unitarian Church</p>
						<p class="event-address">
