...
class PLL_Active_Languages {
	...
	public function __construct( &$polylang ) {
		...
		// Admin
		if ( $polylang instanceof PLL_Settings && ( empty( $_GET['page'] ) || 'mlang' == $_GET['page'] ) ) {
	...
	public function _enable( $lang_id, $enable ) {
		...
		wp_update_term( $lang_id, 'language', array( 'description' => serialize( $description ) ) );
